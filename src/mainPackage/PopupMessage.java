...
public class PopupMessage {
    ...
    public PopupMessage(final String s) {
        EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                ...
                new PopupMessageBuilder().withDelay(1000).withMessage(s).at(new Point((int)(Program.window.getX() + 
                		Program.window.getSize().getWidth()/2)-50, (int) (Program.window.getY() + 
                				Program.window.getSize().getHeight())-100)).show();
            }
        });
    }
